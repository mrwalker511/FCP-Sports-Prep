...
<div class="wp-block-group alignfull is-style-grid-background has-background" style="background-color:var(--wp--preset--color--tertiary);padding-top:8rem;padding-bottom:8rem">
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column" style="flex-basis:33.33%">
            ...
            <figure class="wp-block-image size-large is-style-animate-slide-in"><img src="assets/images/placeholder-basketball-drill.webp" alt="Elite basketball player executing a training drill on the court"/></figure>
            <!-- /wp:image -->
        ...
        <div class="wp-block-column" style="flex-basis:66.66%">
            <!-- wp:image {"sizeSlug":"large","linkDestination":"none","className":"is-style-animate-slide-in"} -->
            <figure class="wp-block-image size-large is-style-animate-slide-in"><img src="assets/images/placeholder-basketball-arena.webp" alt="Full-court view of the basketball arena during a competitive game"/></figure>
            <!-- /wp:image -->
        </div>
        <!-- /wp:column -->
    </div>
