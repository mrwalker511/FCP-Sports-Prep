...
<div class="wp-block-query alignwide">
    ...
    <!-- wp:group {"className":"faculty-card has-shadow-xl","style":{"spacing":{"padding":{"top":"1.5rem","right":"1.5rem","bottom":"1.5rem","left":"1.5rem"},"blockGap":"1rem"},"border":{"width":"1px","style":"solid","color":"rgba(17,34,64,0.05)"},"color":{"background":"var(--wp--preset--color--base)"}},"layout":{"type":"flex","orientation":"vertical"}} -->
