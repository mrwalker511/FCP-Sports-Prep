...
<div class="wp-block-query alignwide">
    ...
    <!-- wp:group {"className":"faculty-card group has-shadow-xl","style":{"spacing":{"padding":{"top":"1.5rem","right":"1.5rem","bottom":"1.5rem","left":"1.5rem"},"blockGap":"1rem"},"border":{"width":"1px","style":"solid","color":"rgba(17,34,64,0.05)"},"color":{"background":"#ffffff"}},"layout":{"type":"flex","orientation":"vertical"}} -->
    <div class="wp-block-group faculty-card group has-shadow-xl has-background"
        style="border-color:rgba(17,34,64,0.05);border-style:solid;border-width:1px;background-color:#ffffff;padding-top:1.5rem;padding-right:1.5rem;padding-bottom:1.5rem;padding-left:1.5rem">
