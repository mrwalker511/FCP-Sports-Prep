...
Tags: block-styles, full-site-editing, custom-colors, editor-style, one-column, wide-blocks
...
- **Schedule** - Display game schedules and results
...
= Fonts =
Bebas Neue, Oswald, and Inter are loaded via theme.json fontFace declarations.
...
= Images =
Pattern placeholder images use Unsplash photos (https://unsplash.com/license) and should be replaced with original content for production use.
